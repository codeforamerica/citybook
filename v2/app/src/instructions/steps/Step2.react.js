    ...
    return(
      <Row>
        <Col md={4}>
          ...
          <img class="img-responsive" src="../../img/publish_to_web_small-1.png" />
        </Col>
        <Col md={4}>
          <p>In the next window, click the blue "publish" button. When asked, "Are you sure…?" click OK.</p>
          <img class="img-responsive" src="../../img/publish_to_web_button_small.png" />
        </Col>
        <Col md={4}>
          <p>Now, copy the URL that appears in the center of the window. You'll use this in the next step.</p>
          <img class="img-responsive" src="../../img/publish_to_web_url_small.png" />
        </Col>
      </Row>
    )
  }
